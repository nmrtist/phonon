...
macro_rules! register_core {
    ($label:expr, $conn:expr, $name:expr) => {
        BuiltinComponent::new(
            $label,
            $conn,
            include_str!(concat!("building_block/core/", $name, ".psf")),
        )
    };
}
...
macro_rules! register_linker {
    ($label:expr, $name:expr) => {
        BuiltinComponent::new(
            $label,
            2,
            include_str!(concat!("building_block/linker/", $name, ".psf")),
        )
    };
}
...
macro_rules! register_fg {
    ($label:expr, $name:expr) => {
        BuiltinComponent::new(
            $label,
            1,
            include_str!(concat!("building_block/functional_group/", $name, ".psf")),
        )
    };
}
