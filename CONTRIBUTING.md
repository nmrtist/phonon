...
How to build, test, and land changes in Phonon. Before you start, read
...
cargo run --release -- <script.psh> --name value    # run a script headless
...
- **`externals-ref/`** holds vendored upstream source kept locally as read-only
  API/format reference. It is untracked. Read it; never edit or commit it.
- **`plans/`** holds strategic / roadmap notes.
